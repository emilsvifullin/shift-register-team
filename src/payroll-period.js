...
/*
  Разница между тем, сколько причитается сейчас, и тем, что записано
  выплатами.
  ...
  Считается она от текущего счёта, а не от снимка — и в закрытом периоде
  тоже. Снимок брался за основу из опасения, что «недоплата» станет
  дёргаться от любой правки. Но правку в закрытом периоде нельзя сделать
  мимоходом: сервер отказывает, согласие приходит отдельным доводом и
  попадает в историю. Раз изменение приняли осознанно, деньги изменились
  вместе с ним — и молчать об этом нельзя. Со снимком выходило ровно
  наоборот: период показывал «к выплате 7 500, выплачено 6 500» и при
